...
void Operator_SEE(
	...
	kcg_bool inC_H1RRF001MDX_value,
	kcg_bool outC_N1RRFS012N1X14_status,
	kcg_bool outC_N1RRFS012N1X14_value,
	...
	kcg_bool inC_S1RRF002XUSVAL,
	kcg_bool inC_S1RRF002XUHYST,
	kcg_bool outC_Context_46_O1_status,
	kcg_bool outC_Context_46_O1_value,
	kcg_bool outC_Context_46_init,
	kcg_bool outC_Context_46_SM1_state_nxt,
	kcg_bool outC_Context_46_OutputValue
)
{
	/*2*/
	FSF_POL_TIME_DEPENDENT_analog_SEE(outC_N1KRP091KS_status, outC_N1KRP091KS_value,
	...
	/*3*/
	DFL_POL_TIME_DEPENDENT_binary_SEE(RRFS012B01_1_out_status,
		RRFS012B01_1_out_value,
	...
	/*13*/
	THC_ANA_TIME_DEPENDENT_SEE(outC_Context_75_O1_status,
		outC_Context_75_O1_value,
	...
	/*2*/
	FSF_POL_TIME_DEPENDENT_analog_SEE(outC_Context_46_O1_status, outC_Context_46_O1_value,
		inC_H1RRF001MDX_status, inC_H1RRF001MDX_value,
		outC_N1RRFS012N1X14_status, outC_N1RRFS012N1X14_value);
	...
	/*1*/
	NOT_BIN_TIME_INDEPENDENT_SEE(RRFS012B01_1_out_status, RRFS012B01_1_out_value, outC_N1KRP091KS_status, outC_N1KRP091KS_value);


	/*13*/
	THC_ANA_TIME_DEPENDENT_SEE(outC_N1KRP091KS_status,
	...
	/*1*/
	NOT_BIN_TIME_INDEPENDENT_SEE(outC_Context_46_O1_status, outC_Context_46_O1_value, outC_N1KRP091KS_status, outC_N1KRP091KS_value);



	/*13*/
	THC_ANA_TIME_DEPENDENT_SEE(
	...
	/*1*/
	NOT_BIN_TIME_INDEPENDENT_SEE(outC_N1RRFS012N1X14_status, outC_N1RRFS012N1X14_value, outC_N1KRP091KS_status, outC_N1KRP091KS_value);
	...
	/*3*/
	DFL_POL_TIME_DEPENDENT_binary_SEE(
		outC_N1RRFS012N1X14_status,
		outC_N1RRFS012N1X14_value,
		outC_Context_75_O1_status,
		outC_Context_75_O1_value,
	...
	/*4*/
	FORCE_L_B_POL_TIME_DEPENDENT_binary_SEE(
		outC_Context_75_O1_status,
		outC_Context_75_O1_value,
		inC_RRFS012B01_1_forc_status,
		inC_RRFS012B01_1_forc_value,
...
int main()
{
	...
	klee_make_symbolic(&outC_Context_46_SM1_state_nxt, sizeof(outC_Context_46_SM1_state_nxt), "outC_Context_46_SM1_state_nxt");
