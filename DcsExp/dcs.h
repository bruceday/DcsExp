...
typedef struct inC_Operator {
	...
	kcg_real S1KRP153XUSVAL;
	kcg_real S1KRP153XUHYST;
	binary Context_33;
	binary H1YDA101MPBF;
	binary KRPF031B02_1_force;
	kcg_int KRPF031B02_1_b_force;
	analog KRPF031B02_1_out;
	outC_DFL_POL_TIME_DEPENDENT_binary Context_72;
	outC_DFL_POL_TIME_DEPENDENT_binary Context_71;
	binary H1YDA101MTB;
	binary H1YDA101MTBF;
	binary H1YDA101MTX;
	...
	binary N1KRP183IA;
	outC_THC_ANA_TIME_DEPENDENT Context_31;
	outC_THC_ANA_TIME_DEPENDENT Context_30;
	binary N1KRP186IA;
	kcg_real S1KRP152XUSVAL;
	kcg_real S1KRP152XUHYST;
...
typedef struct  outC_Operator {
	...
	kcg_real S1KRP153XUSVAL;
	kcg_real S1KRP153XUHYST;
	outC_THC_ANA_TIME_DEPENDENT Context_33;
	binary H1YDA101MPBF;
	binary N1KRP183IA;
	binary KRPF031B02_1_force;
	kcg_int KRPF031B02_1_b_force;
