...
void Operator(inC_Operator *inC,outC_Operator *outC)
{
	...
	THC_ANA_TIME_DEPENDENT(&outC->H1KRPF030N3X14,inC->S1KRP154XUHSVAL,inC->S1KRP154XUHYST,&outC->Context_32);
	kcg_copy_binary(&outC->N1KRPF030N2X12_N01,&outC->Context_32.O1);
	DFL_POL_TIME_DEPENDENT_binary(&inC->H1KRP026CC1,&outC->Context_73);

	
	
	kcg_copy_binary(&tmp6,&outC->Context_73.O1);
	NOT_BIN_TIME_INDEPENDENT(&tmp6,&outC->N1KRP088KS);
	BSO_BIN_TIME_INDEPENDENT(&outC->KCS501B01_1_out,&inC->N1KRPF030N4X21_N01,&outC->KCS501B02_1_out,&inC->N1KRPF030N4X21_N02,&tmp5);
	BSO_BIN_TIME_INDEPENDENT(&outC->KCS501B01_1_out,&inC->N1KRPF030N6X31_N01,&outC->KCS501B02_1_out,&inC->N1KRPF030N6X31_N02,&tmp4);
	Vote_2_3_RA_BIN_TIME_INDEPENDENT(&outC->N1KRPF030N2X12_N01,&tmp5,&tmp4,&tmp6);
	AND2_BIN_TIME_INDEPENDENT_AND(&tmp6,&outC->N1KRP088KS,&outC->N1KRPF030N7X14);
	THC_ANA_TIME_DEPENDENT(&outC->N1KRPF030N3X14,inC->S1KRP153XUSVAL,inC->S1KRP153XUHYST,&outC->Context_33);
	kcg_copy_binary(&outC->N1KRP183IA,&outC->Context_33.O1);
	FORCE_L_B_POL_TIME_DEPENDENT_binary(&outC->N1KRPF030N7X14, &inC->KRPF031B01_1_force, inC->KRPF031B01_1_b_force, &outC->KRPF031B01_1_out);
	FORCE_L_B_POL_TIME_DEPENDENT_binary(&outC->H1YDA301MPBF,&inC->N1KRPF030N4X21_N02,inC->KRPF031B02_1_b_force,&outC->KRPF031B02_1_out);

	DFL_POL_TIME_DEPENDENT_binary(&inC->H1YDA101MTB,&outC->Context_72);
	kcg_copy_binary(&outC->H1YDA101MTBF,&outC->Context_72.O1);

	FSF_POL_TIME_DEPENDENT_analog(&outC->H1YDA101MTBF,&inC->H1YDA101MTX,&outC->N1KRPF029N3X14);
	THC_ANA_TIME_DEPENDENT(&outC->N1KRPF029N3X14,inC->S1KRP151XUSVAL,inC->S1KRP151XUHYST,&outC->Context_31);
	kcg_copy_binary(&outC->N1KRP180IA,&outC->Context_31.O1);
	THC_ANA_TIME_DEPENDENT(&outC->N1KRPF029N3X14,inC->S1KRP152XUSVAL,inC->S1KRP152XUHYST,&outC->Context_30);
	kcg_copy_binary(&outC->N1KRPF029N2X12_N01,&outC->Context_30.O1);
	DFL_POL_TIME_DEPENDENT_binary(&inC->H1KRP026CC1,&outC->Context_71);
